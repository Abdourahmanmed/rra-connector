/*
  ...
  - The values [SQL_AUTHS] on the enum `SqlAuthType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SqlAuthType_new" AS ENUM ('SQL_AUTH', 'WINDOWS_AUTH');
...
ALTER TABLE "Setting" ALTER COLUMN "sqlAuthType" SET DEFAULT 'SQL_AUTH';
COMMIT;
